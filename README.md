...
of the University of Cologne using nf-core’s (v1.2.1)97 atac-seq pipeline98 (nf-core/atacseq pipeline) in a Singularity99 environment and the corresponding workflow
...
parameters of by nf-core/atac-seq.
